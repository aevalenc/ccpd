...
def CreateBasicInletStage() -> CompressorStage:
    ...
    inlet.blade.mid.relative = VelocityVector(axial=53.9224, tangential=-48.108, magnitude=53.9224, angle=-0.728)
...
class TestOutletLoopCalculations(unittest.TestCase):
    ...
    def test_given_valid_inputs_expect_valid_results(self):
        ...
        outlet = SetupOutletStage(alpha2, self.eulerian_work, outlet_velocity, self.inputs, self.working_fluid)
